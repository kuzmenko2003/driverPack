...
#include <memory>
#include "../../driverPack/autorization.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_autorization_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_autorization_t qt_meta_stringdata_autorization = {
    {
QT_MOC_LITERAL(0, 12), // "autorization"
QT_MOC_LITERAL(13, 11), // "sentMessage"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 7), // "message"
QT_MOC_LITERAL(34, 31), // "updateTimerToReturnAutorization"
QT_MOC_LITERAL(66, 14), // "toAutorization"
QT_MOC_LITERAL(81, 5), // "login"
QT_MOC_LITERAL(87, 6) // "passwd"

    },
    "autorization\0sentMessage\0\0message\0"
    "updateTimerToReturnAutorization\0"
    "toAutorization\0login\0passwd"
};
...
void autorization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sentMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->updateTimerToReturnAutorization(); break;
        case 2: _t->toAutorization((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&autorization::sentMessage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject autorization::staticMetaObject = { {
    ...
    qt_meta_stringdata_autorization.offsetsAndSize,
...
// SIGNAL 0
void autorization::sentMessage(QString _t1)
{
